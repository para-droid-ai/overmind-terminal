...
export const GEMINI_MODEL_NAME_FLASH_DEFAULT = 'gemini-2.5-flash-preview-04-17';
export const GEMINI_MODEL_NAME_PRO_DEFAULT = 'gemini-2.5-pro-experimental-03-25';
export const IMAGEN_MODEL_NAME = 'imagen-3.0-generate-002';
export const GEMINI_MULTIMODAL_MODEL_FOR_ODM = 'gemini-2.5-flash-preview-04-17'; 
...
export const AVAILABLE_MODELS: Array<{id: AIPersona['modelName'], name: string}> = [
  ...
  { id: 'gemini-2.5-pro-experimental-03-25', name: 'Gemini 2.5 Pro Exp (03-25)' },
